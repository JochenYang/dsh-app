/**
 * The composer's real skill reference for the PPT capsule.
 *
 ...
 *
 * @module @dsh-app/plugin-ppt/client/skill-reference
 */
...
export const REFERENCE_SOURCE = 'dsh-office-ppt'

/** Inline label the chip shows in the composer. */
export const CHIP_LABEL = 'PPT'
