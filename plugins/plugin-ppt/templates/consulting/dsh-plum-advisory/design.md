...
Colorway variant of the bundled Signal / 深蓝决策 template: the same twelve editable layouts and geometry, rebuilt around deep plum with a single antique-copper accent. The base edition is adapted from Zara Zhang's Signal, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c, MIT.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Plum Advisory colorway variant 2026-09-12. Derived from the bundled 深蓝决策 template (MIT); see its design document for the pinned upstream source.
