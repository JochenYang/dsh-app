...
Colorway variant of the bundled Editorial Forest / 森林季刊 template: the same twelve editable layouts and geometry, rebuilt around deep indigo with a muted amber accent. The base edition is adapted from Zara Zhang's Editorial Forest, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c, MIT.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Indigo Weekly colorway variant 2026-09-12. Derived from the bundled 森林季刊 template (MIT); see its design document for the pinned upstream source.
