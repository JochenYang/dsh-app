#!/usr/bin/env node
/**
 * Builds the MCP manager plugin's two halves:
 *   lib/index.js  — the host half (Node): the servers.json store, the dynamic
 *     mcp-client mount manager, and the settings routes. Bundled with
 ...
 *     web client loader expects (same shape as plugin-swarm's build).
 *
