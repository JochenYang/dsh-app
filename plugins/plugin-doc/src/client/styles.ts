/**
 * Styles for the office bar and the Word capsule. Alias-token colors only
 ...
 *
 * @module @dsh-app/plugin-doc/client/styles
 */

const STYLE_ID = 'dsh-app-plugin-doc-style'
...
.dshWordCapsuleActive,
.dshWordCapsuleActive:hover {
...
.dshWordCapsuleBody:disabled {
  cursor: default;
  opacity: 0.55;
}
.dshWordCapsuleBody:focus-visible {
