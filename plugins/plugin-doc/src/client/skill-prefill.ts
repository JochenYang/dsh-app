/**
 * Skill-reference insertion policy for the Word capsule.
 *
 ...
 * switching PPT → Word replaces the chip instead of stacking a second one. The
 ...
 *
 * @module @dsh-app/plugin-doc/client/skill-prefill
 */
...
function cleanOfficeDraft(
  ...
  if (input.draft === undefined) {
    console.warn('[dsh-app plugin-doc] the composer draft is unreadable; skipped the office chip cleanup')
    return input
  }
