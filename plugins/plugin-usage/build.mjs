#!/usr/bin/env node
/**
 * Builds the usage plugin's two halves:
 *   lib/index.js  — the host half (Node): usage capture, JSONL store,
 *     backfill, aggregation, and API routes. Bundled with @deepseek-ai/* and
 *     cordis EXTERNAL (they resolve from the profile's node_modules at load
 *     time), like the client half below.
 ...
 *     client loader expects (same shape as plugin-sidebar's build).
 *
