 ...
 *
 * Run from anywhere:
 *   node plugins/plugin-sheet/scripts/test.mjs
...
buildSync({
  ...
  // The bundled CJS dependency (exceljs → jszip/archiver) calls require() for
  // node builtins at render time; ESM output has no require, so hand one over —
