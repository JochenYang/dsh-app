/**
 * Skill-reference insertion policy for the Excel capsule.
 *
 ...
 * switching PPT → Excel replaces the chip instead of stacking a second one. The
...
function cleanOfficeDraft(
  ...
  if (input.draft === undefined) {
    console.warn('[dsh-app plugin-sheet] the composer draft is unreadable; skipped the office chip cleanup')
    return input
  }
