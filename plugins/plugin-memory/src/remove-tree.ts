 ...
 * descends THROUGH a junction, so removing a store whose `topics/` (or a
 * project dir) was linked into someone else's tree would empty that tree
 ...
 *
 * @module @dsh-app/plugin-memory/remove-tree
 */
