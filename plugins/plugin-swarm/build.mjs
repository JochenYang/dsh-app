#!/usr/bin/env node
/**
 * Builds the swarm plugin's two halves:
 *   lib/index.js  — the host half (Node): the swarm tool, the /swarm command,
 *     the batch orchestrator, and the settings routes. Bundled with
 ...
 *     web client loader expects (same shape as plugin-memory's build).
 *
