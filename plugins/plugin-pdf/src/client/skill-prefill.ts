/**
 * Skill-reference insertion policy for the PDF capsule.
 *
 ...
 * switching PPT → PDF replaces the chip instead of stacking a second one. The
 ...
 *
 * @module @dsh-app/plugin-pdf/client/skill-prefill
 */
