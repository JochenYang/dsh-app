/**
 * The composer's real skill reference for the PDF capsule.
 *
 ...
 *
 * @module @dsh-app/plugin-pdf/client/skill-reference
 */
...
export const REFERENCE_SOURCE = 'dsh-office-pdf'

/** Inline label the chip shows in the composer. */
export const CHIP_LABEL = 'PDF'
